...
class StatusBarCompatKitKat {
     ...
     */
    private static void addMarginTopToContentChild(@Nullable View mContentChild, int statusBarHeight) {
     ...
     */
    private static void removeMarginTopOfContentChild(@Nullable View mContentChild, int statusBarHeight) {
        if (mContentChild == null) {
            return;
        }
        if (TAG_MARGIN_ADDED.equals(mContentChild.getTag())) {
     ...
     */
    static void setStatusBarColorForCollapsingToolbar(@NonNull Activity activity, @NonNull final AppBarLayout appBarLayout, @NonNull final CollapsingToolbarLayout collapsingToolbarLayout,
                                                      @NonNull Toolbar toolbar, int statusColor) {
        Window window = activity.getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        ViewGroup mContentView = (ViewGroup) window.findViewById(Window.ID_ANDROID_CONTENT);
