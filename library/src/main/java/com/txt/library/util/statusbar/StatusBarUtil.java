package com.txt.library.util.statusbar;
...
public class StatusBarUtil {
     ...
     */
    public static void setStatusBarColor(@NonNull Activity activity, int colorId, boolean isFollow) {
...
//            window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
     ...
     */
    public static int StatusBarLightMode(@NonNull Activity activity, boolean dark) {
        int result = 0;
     ...
     */
    public static void StatusBarLightMode(@NonNull Activity activity, int type) {
        if (type == 1) {
    ...
    public static void StatusBarLightMode(@NonNull Activity activity) {
        boolean isMiui = MIUISetStatusBarLightMode(activity.getWindow(), true);
        if (isMiui) return;
        boolean isFlyme = MIUISetStatusBarLightMode(activity.getWindow(), true);
        if (isFlyme) return;
     ...
     */
    public static void StatusBarDarkMode(@NonNull Activity activity, int type) {
        if (type == 1) {
