...
public class BannerView<BannerItem> extends FrameLayout {
    public static boolean DEBUG = false;
    private static final String TAG = BannerView.class.getSimpleName();

    public interface ViewFactory<BannerItem> {
        View create(BannerItem item, int position, ViewGroup container);
    }

    public interface TitleAdapter<BannerItem> {
        CharSequence getTitle(BannerItem item);
    }
    ...
    private List<BannerItem> mDataList = new ArrayList();
    ...
    public void setDataList(@NonNull List<BannerItem> list) {
        mDataList = list;
    }
