...
public class RingProgressBar extends View {
    ...
    public RingProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        textColor = mTypedArray.getColor(R.styleable.RingProgressBar_rTextColor, context.getResources().getColor(R.color.gray_text));//字体颜色
        ...
        ringColor = mTypedArray.getColor(R.styleable.RingProgressBar_rRingColor, context.getResources().getColor(R.color.select_title_text));//外层初始圆环的颜色，默认透明
        progressColor = mTypedArray.getColor(R.styleable.RingProgressBar_rProgressColor, context.getResources().getColor(R.color.selected_time_text));//外层进度环的颜色，默认蓝色
