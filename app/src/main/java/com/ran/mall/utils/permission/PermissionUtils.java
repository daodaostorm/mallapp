package com.ran.mall.utils.permission;
...
public final class PermissionUtils {
    ...
    public static List<String> getPermissions() {
        return getPermissions(ApplicationUtils.getApp().getPackageName());
    }
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                ...
                == ContextCompat.checkSelfPermission(ApplicationUtils.getApp(), permission);
    }
    ...
    public static void openAppSettings() {
        ...
        intent.setData(Uri.parse("package:" + ApplicationUtils.getApp().getPackageName()));
    ...
    private void startPermissionActivity() {
        ...
        PermissionActivity.start(ApplicationUtils.getApp());
    }
