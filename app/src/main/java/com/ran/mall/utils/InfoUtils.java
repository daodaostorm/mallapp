...
//        }
    ...
    public static String userInfoCalcAddress(String strAgentId){
        LogUtils.i("userInfoCalcAddress:" + strAgentId);
        String strValue = "";
        if (strAgentId != null && strAgentId.length() >12){
            strValue += strAgentId.substring(strAgentId.length() - 12, strAgentId.length() - 10) + ":";
            strValue += strAgentId.substring(strAgentId.length() - 10, strAgentId.length() - 8) + ":";
            strValue += strAgentId.substring(strAgentId.length() - 8, strAgentId.length() - 6) + ":";
            strValue += strAgentId.substring(strAgentId.length() - 6, strAgentId.length() - 4) + ":";
            strValue += strAgentId.substring(strAgentId.length() - 4, strAgentId.length() - 2 ) + ":";
            strValue += strAgentId.substring(strAgentId.length() - 2, strAgentId.length());
        }
        LogUtils.i("userInfoCalcAddress out:" + strValue);
        return strValue;
    }
}
