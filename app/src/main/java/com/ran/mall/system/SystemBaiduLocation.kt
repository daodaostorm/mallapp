...
class SystemBaiduLocation : SystemBase() {
    private val TAG = SystemBaiduLocation::class.java.simpleName
    var mInfo: LocationInfo? = null
    ...
    fun initLocation() {
        locationService = LocationService(MainApplication.getInstance())
    ...
    private val mListener = object : BDAbstractLocationListener() {
        ...
        override fun onReceiveLocation(location: BDLocation?) {
            ...
            if (null != location && location.locType != BDLocation.TypeServerError) {
                ...
                LogUtils.i("Baidumap", "onReceiveLocation: " + sb.toString())
